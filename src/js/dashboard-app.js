        ...
        async loadStats() {
            ...
            try {
                ...
                scoutSnap.forEach(doc => {
                    ...
                    // Scouter teams (from reports metadata)
                ...
                // Process Pit Reports for unique teams and additional scouter activity
                pitSnap.forEach(doc => {
                    const data = doc.data();
                    const team = data.teamNumber;
                ...
                // For "Most users in team" specifically (user records)
